...
const (
	...
	Inventory_Rollback_FullMethodName  = "/Inventory/Rollback"
)
...
type InventoryClient interface {
	...
	Rollback(ctx context.Context, in *SellInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *inventoryClient) Rollback(ctx context.Context, in *SellInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Inventory_Rollback_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServer interface {
	...
	Rollback(context.Context, *SellInfo) (*emptypb.Empty, error)
...
func (UnimplementedInventoryServer) Rollback(context.Context, *SellInfo) (*emptypb.Empty, error) {
...
func _Inventory_Rollback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Inventory_Rollback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
